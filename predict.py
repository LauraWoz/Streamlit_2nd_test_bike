...
@st.cache
def train_and_test_predictive_model(df):
    ...
    def get_day(day_start):
        ...
        return pd.date_range(day_start, day_end, freq="H").tz_localize('US/Eastern')
    ...
    score = get_rmsle(y_p, rf_t)

    _, df_test_internal = custom_train_test_split(get_data())
    df_test_internal['count'] = y_p
    ...
    final_df = df_test[['datetime', 'count']].append(df_test_internal[['datetime', 'count']])
